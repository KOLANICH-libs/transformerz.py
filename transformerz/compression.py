...
class compressorsMeta(type):
	...
	def __new__(cls: typing.Type["compressorsMeta"], className: str, parents: tuple, attrs: typing.Dict[str, typing.Any], *args, **kwargs) -> typing.Type["compressors"]:
		...
		from .kaitai.compress.algorithms.zlib import Container as KaitaiZlibContainerType
		from .kaitai.compress.algorithms.zlib import Zlib as KaitaiZlib
		from .kaitai.compress.algorithms.zlib import zlib
		...
		try:
			from .kaitai.compress.algorithms.lzma import Lzma as KaitaiLzma
			from .kaitai.compress.algorithms.lzma import lzma

...
TransformerFuncT = typing.Callable[[typing.Any], typing.Any]
...
class Transformer(TransformerBase):
	...
	def __init__(self, name: str, unprocess: TransformerFuncT, process: TransformerFuncT, srcType: type, tgtType: type) -> None:
...
class FileTransformer(Transformer):
	...
	def __init__(self, name: str, unprocess: TransformerFuncT, process: TransformerFuncT, srcType: type, tgtType: type, fileExtension: str, mimeType: typing.Optional[str] = None) -> None:
